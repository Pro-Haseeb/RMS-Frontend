...
export default function CompanySidebar({ open, onClose }) {
  ...
  try {
    ...
    if (userStr) {
      ...
      role = typeof user.role === "string" ? user.role.toLowerCase() : "";
    }
  } catch (e) {
    ...
    >
      ...
      >
        ...
        <Box
          sx={{
            ...
            "&:hover": {
              ...
              boxShadow: "0 18px 45px rgba(25,118,210,0.45)"
            }
          }}
        >
          AI
        ...
        <Typography sx={{ color: "#94a3b8", fontSize: "13px", mt: 0.5 }}>
          {isCompanyAdmin ? "Admin Dashboard" : "HR Dashboard"}
        </Typography>
      </Box>
            ...
            <ListItemButton
              ...
              sx={{
                ...
                "&:hover": {
                  ...
                  boxShadow: "0 10px 25px rgba(66,165,245,0.12)"
                },
